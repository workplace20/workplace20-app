...
const ProcessNav = ({
  ...
  const steps = [
    ...
    {
      stepNumber: '03',
      description: 'Pass your 1st skill',
      completed: firstSkillCompleted,
      isCurrent: generalChallengeCompleted && !firstSkillCompleted,
      href: '#'
    },
    {
      stepNumber: '04',
      description: 'Review',
      completed: reviewed,
      isCurrent: !reviewed && generalChallengeCompleted && firstSkillCompleted,
      href: '#'
    }
  ];
