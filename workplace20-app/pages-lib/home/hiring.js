	...
	<div className="bg-white">
		...
		<div class="relative bg-white ">
			<div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
				<h2 class="text-base font-semibold tracking-wider text-orange-600 uppercase">
					Our Services
				</h2>
				<p class="mt-2 text-3xl font-extrabold text-orange-400 tracking-tight sm:text-4xl">
						...
						<div class="pt-6">
							<div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
								<div class="-mt-6">
									...
									<p class="mt-5 text-base text-gray-500">
										Qui aut temporibus nesciunt vitae dicta
										repellat sit dolores pariatur.
						...
						<div class="pt-6">
							<div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
								<div class="-mt-6">
									...
									<p class="mt-5 text-base text-gray-500">
										Rerum quas incidunt deleniti quaerat
										suscipit mollitia. Amet repellendus ut
										odit dolores qui.
									</p>
								</div>
							</div>
						...
						<div class="pt-6">
							<div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
								<div class="-mt-6">
									...
									<p class="mt-5 text-base text-gray-500">
										Ullam laboriosam est voluptatem maxime
										ut mollitia commodi. Et dignissimos
							...
							<div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
								<div class="-mt-6">
									...
									<p class="mt-5 text-base text-gray-500">
										...
										veritatis aliquam. Veritatis labore
							...
							<div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
								<div class="-mt-6">
									...
									<p class="mt-5 text-base text-gray-500">
										...
										consectetur. Ratione similique et
										impedit ea ipsum et.
									</p>
								</div>
							</div>
