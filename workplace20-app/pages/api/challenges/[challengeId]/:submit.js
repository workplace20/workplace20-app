...
async function handlePut(req, res) {
	...
	const [challenge, error] = await profileDomain.getNextLevelOf(challengeId);
	...
	const [score, submitError] = await challengeDomain.submit(
		challenge,
		session.user.email
	);
	...
	await profileDomain.setSkill(challenge.challengeId, challenge.level, score);
